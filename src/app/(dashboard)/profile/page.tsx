    ...
    <div className='mx-auto py-10 space-y-10 px-4 sm:px-0 max-w-7xl'>
      <div className='flex items-center space-x-4'>
        <div className='flex items-center justify-between w-full'>
          <div className='flex items-center gap-4'>
            ...
            />
            <div>
              <span className="text-lg font-bold leading-tight capitalize">{user?.name}</span>
              <span className="text-muted-foreground text-sm mt-1 block">{user?.email}</span>
            </div>
          </div>
          <div className="mt-2">
      ...
      <div className='space-y-6 mt-6'>
        <div className='flex justify-between items-center border-b pb-4'>
          ...
          <Button variant='secondary' className='cursor-pointer' onClick={toggle}>
      ...
      <div className='mt-20 flex flex-col justify-center items-center gap-2'>
        ...
        <span className='text-sm text-muted-foreground'>Built with Next.js, Tailwind CSS, Prisma, and NextAuth.js</span>
      </div>
    </div>
    </>
  )
